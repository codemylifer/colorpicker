...
OSErr PSSDKWrite(intptr_t refNum, int32 * count, void * buffPtr)
{
...
OSErr PSSDKSetFPos(intptr_t refNum, short posMode, long posOff)
{
...
OSErr PSSDKRead(intptr_t refNum, int32 * count, void * buffPtr)
{
	if (NULL == count || NULL == buffPtr)
		return readErr;
