...
typedef struct ReadDescriptorProcs
	...
	GetAliasProc				getAliasProc;		/**< Function pointer to get an alias value from a descriptor. */
...
#define kPSActionControlSuiteVersion	 	4	// Current version, but it's
#define kPSActionControlSuitePrevVersion	3	// compatible with version 3
#define kPSActionControlSuiteOldestVersion	2	// and compatible with verison 2
