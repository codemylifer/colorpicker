 ...
 *
 * Build Info, it is recommended that third party developers use the same tools
 * that were used to build Photoshop. Look here for that information. It was
 * also noted in the What's New section of the Photoshop SDK HTML documentation
 * 
 ******************************************************************************
 * 
 * <b>Photoshop 16.0 ( CC 2015 ) </b>
 * 
