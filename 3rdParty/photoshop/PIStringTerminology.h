...
#define kexpFeatureArtboardsStr "expFeatureArtboards"
#define kexpFeaturePlaygroundStr "expFeaturePlayground"
...
// 09/02/14 Deprecated. Originally added in 2009 for Mini Bridge, to check for
// QuickTime being installed on Windows. Since CS6, PS has typically just returned
// true for this property, with the unwanted side effect of launching DynamicLink Media Server.
// Now PS just returns true if the video feature is generally available,
// without launching DLMS. -aerickso
...
#define kshowExternalUIStr "showExternalUI"
...
#define kstartExternalUIOnLaunchStr "startExternalUIOnLaunch"
